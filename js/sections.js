...
var scrollVis = function() {
  ...
  var setupSections = function() {
    ...
    activateFunctions[2] = showTeddyHist;
    activateFunctions[3] = showOtherHist; // <- note the use of the other callback function
    activateFunctions[4] = showTeddyHist;
    activateFunctions[5] = showFillerTitle;
    activateFunctions[6] = showTeddyHist;
    activateFunctions[7] = showFillerTitle;
    activateFunctions[8] = showTeddyHist;
  ...
  function showOtherHist() {
    showHistAll(allData["other"]);
  }
...
function displayData(error, teddyData, otherData) {
  ...
  const data = { teddy: teddyData, other: otherData };
...
d3.queue()
  .defer(d3.tsv, "theodore_roosevelt.tsv")
  .defer(d3.tsv, "fake_other.tsv")
  .await(displayData);
